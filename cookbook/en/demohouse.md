...
```{note}
In our Demo House, you can explore various demonstration projects showcasing how to build agent applications using AgentScope Runtime Java. These demo projects are hosted in [this repository](https://github.com/agentscope-ai/agentscope-runtime-java). Visit to see the capabilities of AgentScope Runtime Java.
```

<div class="gallery-container">
    <a class="gallery-item"
       href="https://github.com/agentscope-ai/agentscope-runtime-java/tree/main/examples/browser_use_fullstack_runtime">
        <div class="gallery-item-card">
            ...
            <div class="gallery-item-card-content">
                ...
                <div class="gallery-item-description">
                    Create a web browser control agent using browser sandbox in AgentScope Runtime Java.
                </div>
            </div>
        </div>
    </a>
