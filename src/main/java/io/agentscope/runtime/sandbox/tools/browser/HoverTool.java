 ...
 * Browser hover tool
 */
public class HoverTool extends SandboxTool {
    ...
    public ToolCallback buildTool() {
        ...
        return FunctionToolCallback
                ...
                .inputSchema(
                        inputSchema
                ).inputType(HoverExecutor.Request.class)
    ...
    class HoverExecutor implements BiFunction<HoverExecutor.Request, ToolContext, HoverExecutor.Response> {
        ...
        public Response apply(Request request, ToolContext toolContext) {
            ...
            String result = browser_hover(request.element, request.ref, userID, sessionID);
            return new Response(result, "Browser hover completed");
        }

        private String browser_hover(String element, String ref, String userID, String sessionID) {
            try {
