...
/**
 * Base class for services with lifecycle management capabilities
 * Combines Service interface and lifecycle management functionality, providing a convenient base class for most service implementations
 */
